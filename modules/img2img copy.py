...
def img2img(id_task: str, mode: int, prompt: str, negative_prompt: str, 
    ...
    inpaint_color_sketch_orig, init_img_inpaint, init_mask_inpaint, steps: int,
    sampler_index: int, mask_blur: int, mask_alpha: float, inpainting_fill: int, 
    ...
    img2img_batch_inpaint_mask_dir: str, *args):
